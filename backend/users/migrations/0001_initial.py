    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_pace', models.CharField(choices=[('relaxed', 'Relaxed'), ('moderate', 'Moderate'), ('fast', 'Fast')], default='moderate', max_length=20)),
                ('budget_preference', models.CharField(choices=[('budget', 'Budget'), ('mid', 'Mid-range'), ('premium', 'Premium')], default='mid', max_length=20)),
